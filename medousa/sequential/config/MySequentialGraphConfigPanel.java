 ...
 */
public class MySequentialGraphConfigPanel
extends JPanel
implements Serializable {
    ...
    public MySequentialGraphConfigPanel() {
        SwingUtilities.invokeLater(new Runnable() {
            @Override public void run() {
                try {
                    ...
                    configWestPanel.setBounds(new Rectangle(60, 40, 620, 650));
                    configEastPanel.setBounds(new Rectangle(735, 40, 620, 650));
