...
public class MyEdgeValueFeatureGenerator {
    ...
    public void generateEdgeValueFeatures(String edgeValueVariable, ArrayList<ArrayList<String>> dataIn, String edgeValueType) {
        this.fw = new MyWeightFeatureWriter(edgeValueVariable.replaceAll(" ", "").toLowerCase(Locale.ENGLISH) + MySequentialGraphVars.edgeValueFileExt);
        setObjectIDIndex();
    ...
    private void run(ArrayList<ArrayList<String>> dataIn, String edgeValueType) {
        try {
            String itemsetDelimeter = ((edgeValueType.contains("DIFFERENCE") || edgeValueType.contains("MAXIMUM")) ? ":" : MySequentialGraphVars.hyphenDelimeter);
            String items = "";
            String weights = "";
            String itemSeq = "";
            String weightSeq = "";
