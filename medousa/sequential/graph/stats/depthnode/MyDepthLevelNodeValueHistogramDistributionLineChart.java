...
implements ActionListener {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            @Override public void run() {
                try {
                    ...
                    depthNodeValueMap = MySequentialGraphSysUtil.sortMapByLongValue(depthNodeValueMap);
                    ...
                    JLabel titleLabel = new JLabel(" DEPTHNODES");
                    titleLabel.setToolTipText("DEPTH NODE BAR CHART");
    ...
    public void enlarge() {
        ...
        try {
            MAXIMIZED = true;
            JFrame f = new JFrame(" DEPTH NODES");
            f.setLayout(new BorderLayout(3, 3));
            f.getContentPane().add(new MyDepthLevelNodeValueHistogramDistributionLineChart(), BorderLayout.CENTER);
