...
public class MyMultiNodeSuccessorValueHistogramDistributionLineChart
extends JPanel
implements ActionListener {
    ...
    public MyMultiNodeSuccessorValueHistogramDistributionLineChart() {
        this.decorate();
    }
        ...
        SwingUtilities.invokeLater(new Runnable() {
            @Override public void run() {
                try {
                    ...
                    for (MyNode successor : MySequentialGraphVars.getSequentialGraphViewer().multiNodeSuccessors) {
                        String sName = (successor.getName().contains("x") ? MySequentialGraphSysUtil.decodeVariable(successor.getName()) : MySequentialGraphSysUtil.getDecodedNodeName(successor.getName()));
                    ...
                    successorNodeValueMap = MySequentialGraphSysUtil.sortMapByLongValue(successorNodeValueMap);
                    ...
                    titleLabel.setToolTipText("MULTINODE SUCCESSOR VALUES");
    ...
    public void enlarge() {
        ...
        try {
            ...
            f.getContentPane().add(new MyMultiNodeSuccessorValueHistogramDistributionLineChart(), BorderLayout.CENTER);
