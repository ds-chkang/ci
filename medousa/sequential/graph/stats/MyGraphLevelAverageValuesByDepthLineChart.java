...
implements ActionListener {
    ...
    private XYSeries totalNodesByDepthSereis;
    private XYSeries totalContributionByDepthSereis;
    private XYSeries totalInContributionByDepthSereis;
    private XYSeries totalOutContributionByDepthSereis;
    private XYSeries totalPredecessorByDepthSereis;
    private XYSeries totalSuccessorByDepthSereis;
    private XYSeries totalReachTimeByDepthSereis;
    private XYSeries totalDurationByDepthSereis;
    private XYSeries averageContributionByDepthSeries;
    private XYSeries averageInContributionByDepthSeries;
    private XYSeries averageOutContributionByDepthSeries;
    private XYSeries averagePredecessorByDepthSeries;
    private XYSeries averageSuccessorByDepthSeries;
    private XYSeries averageReachTimeByDepthSeries;
    private XYSeries averageDurationByDepthSeries;
    private Set<String> filteredNodes;
    ...
    private void setData() {
        ...
        for (int i = 1; i <= MySequentialGraphVars.mxDepth; i++) {
            ...
            for (MyNode n : nodes) {
                if (!filteredNodes.contains(n.getName())) {
        ...
        try {
            ...
            SwingUtilities.invokeLater(new Runnable() {
                @Override public void run() {
                    ...
                    JComboBox graphOptionComboBox = new JComboBox();
                    String[] tooltips = {
                    ...
                    graphOptionComboBox.setSelectedIndex(selectedGraph);
                    graphOptionComboBox.addActionListener(new ActionListener() {
                        @Override public void actionPerformed(ActionEvent e) {
                            if (!MAXIMIZED) {instances = 0;}
                            selectedGraph = graphOptionComboBox.getSelectedIndex();
                            decorate();
                        }
                    });
