...
public class MyClusteredGraphLevelEdgeValueBarChart
extends JPanel {
    ...
    public MyClusteredGraphLevelEdgeValueBarChart() {
        SwingUtilities.invokeLater(new Runnable() {
            @Override public void run() {
                setClusteredEdgeValueBarChart();
    ...
    public void setClusteredEdgeValueBarChart() {
    ...
    @Override public void paint(Graphics g) {
        try {
            ...
            g.drawString("CLUSTERED EDGE VALUES", 0, (9 * (i + 1)) + ((i * gap)));
            i++;
