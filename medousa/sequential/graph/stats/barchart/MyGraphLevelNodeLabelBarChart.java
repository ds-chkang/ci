...
public class MyGraphLevelNodeLabelBarChart extends JPanel {
    ...
    public MyGraphLevelNodeLabelBarChart() {
    ...
    public synchronized void setNodeValueBarChart() {
        ...
        for (MyNode n : nodes) {
            ...
            if (n.nodeLabelMap.containsKey(MySequentialGraphVars.getSequentialGraphViewer().vc.nodeLabelSelecter.getSelectedItem().toString())) {
                if (this.data.containsKey(n.nodeLabelMap.get(MySequentialGraphVars.getSequentialGraphViewer().vc.nodeLabelSelecter.getSelectedItem().toString()))) {
                    float exValue = this.data.get(n.nodeLabelMap.get(MySequentialGraphVars.getSequentialGraphViewer().vc.nodeLabelSelecter.getSelectedItem().toString()));
                    this.data.put(n.nodeLabelMap.get(MySequentialGraphVars.getSequentialGraphViewer().vc.nodeLabelSelecter.getSelectedItem().toString()), ((long) exValue) + 1);
                } else {
                    this.data.put(n.nodeLabelMap.get(MySequentialGraphVars.getSequentialGraphViewer().vc.nodeLabelSelecter.getSelectedItem().toString()).toString(), 1L);
        ...
        this.data = MySequentialGraphSysUtil.sortMapByLongValue(this.data);
    ...
    @Override public synchronized void paint(Graphics g) {
        ...
        FontMetrics fontMetrics = g.getFontMetrics(MySequentialGraphVars.tahomaBoldFont12);
        int titleStringWidth = fontMetrics.stringWidth("NODE LABELS");
        g.drawString("NODE LABELS", (this.getWidth() - (titleStringWidth + 3)), (10 * (i + 1)) + ((i * this.gap)) - 1);
        ...
        for (String name : this.data.keySet()) {
            if (nodeCnt < 100) {
                ...
                fontMetrics = g.getFontMetrics(MySequentialGraphVars.f_pln_12);
