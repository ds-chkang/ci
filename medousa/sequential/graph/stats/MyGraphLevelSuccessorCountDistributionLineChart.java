...
public class MyGraphLevelSuccessorCountDistributionLineChart extends JPanel {
            ...
            @Override public void run() {
                try {
                    ...
                    for (MyNode n : nodes) {
                        ...
                        int successors = MySequentialGraphVars.g.getSuccessorCount(n);
                        if (successors > 0) {
    ...
    private static int BAR_LIMIT = 1500;
    ...
    private void setSuccessorCountBarChart() {
        ...
        for (MyNode n : nodes) {
            ...
            valueMap.put(nodeName, (long) MySequentialGraphVars.g.getSuccessorCount(n));
