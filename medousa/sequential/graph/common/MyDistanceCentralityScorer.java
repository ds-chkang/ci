 ...
 */
public class MyDistanceCentralityScorer<V,E> implements VertexScorer<V, Double>
{
    /**
     ...
     */
    public MyDistanceCentralityScorer(Hypergraph<V,E> graph, Distance<V> distance,
     ...
     * to itself should be included in its score.
     */
    public MyDistanceCentralityScorer(Hypergraph<V,E> graph,
     ...
     * to itself should be included in its score.
     */
    public MyDistanceCentralityScorer(Hypergraph<V,E> graph, boolean averaging,
            boolean ignore_missing, boolean ignore_self_distances)
    {
