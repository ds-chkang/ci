 ...
 */
public class MyPageRank<V,E> extends PageRankWithPriors<V,E>
{
     ...
     */
    public MyPageRank(Hypergraph<V,E> graph, Transformer<E, ? extends Number> edge_weight, double alpha)
    {
     ...
     * @param alpha the probability of taking a random jump to an arbitrary vertex
     */
    public MyPageRank(Hypergraph<V,E> graph, double alpha)
    {
