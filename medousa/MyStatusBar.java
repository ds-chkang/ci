...
import medousa.message.MyTimerThread;
...
extends MyJStatusBar {
	...
	public MyStatusBar() {
		createStatusBar(MyDirectGraphVars.statusAppVerMsg);
	}
	
	private void createStatusBar(final String msg) {
        final JLabel date = new JLabel();

        date.setFont(MyDirectGraphVars.tahomaPlainFont12);
		date.setHorizontalAlignment(JLabel.CENTER);
		date.setVerticalAlignment(JLabel.BOTTOM);

        final JLabel time = new JLabel();
        time.setFont(MyDirectGraphVars.tahomaPlainFont12);
        ...
        title.setFont(MyDirectGraphVars.tahomaPlainFont12);
