...
public class MyDirectGraphEdgeLabelTabPane
extends MyDirectGraphTabPane {

    private final String TAB_TITLE = " EDGE LABELS  ";
    private MyDirectGraphEdgeLabelTable edgeNameTable;
    ...
    public MyDirectGraphEdgeLabelTabPane() {
        super();
        this.decorate();
    }
    ...
    public void setTable() {
        this.edgeNameTable = new MyDirectGraphEdgeLabelTable() {@Override
            public TableCellRenderer getCellRenderer(int row, int column) {return new MyParameterTableRowHeaderRenderer();}
        };
        this.edgeNameTable.setBorder(BorderFactory.createEtchedBorder());
        this.tableScrollPane = new JScrollPane(this.edgeNameTable);
    ...
    public MyDirectGraphEdgeLabelTable getTable() {return this.edgeNameTable;}
}