...
public class MyDirectGraphNodeLabelTabPane
extends MyDirectGraphTabPane {
    ...
    private MyDirectGraphNodeLabelTable nodeLabelTable;
    private String [] headers;
    public File dataFile;

    public MyDirectGraphNodeLabelTabPane() {
        super();
        this.decorate();
    }
    ...
    public void setTable() {
        this.nodeLabelTable = new MyDirectGraphNodeLabelTable() {@Override
    ...
    public MyDirectGraphNodeLabelTable getTable() {return this.nodeLabelTable;}
}