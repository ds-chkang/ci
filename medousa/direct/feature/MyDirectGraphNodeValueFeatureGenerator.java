 ...
 */
public class MyDirectGraphNodeValueFeatureGenerator {
    ...
    public MyDirectGraphNodeValueFeatureGenerator() {}

    public void generateValueFeatures(String edgeValueVariable, ArrayList<ArrayList<String>> dataIn, String edgeValueType) {
        this.fw = new MyDirectGraphWeightFeatureWriter(edgeValueVariable.replaceAll(" ", "").toLowerCase(Locale.ENGLISH) + MyDirectGraphVars.nodeValueFileExt);
        setObjectIDIndex();
    ...
    private void run(ArrayList<ArrayList<String>> dataIn, String edgeValueType) {
        try {
            String itemsetDelimeter = (edgeValueType.contains("TIME") || edgeValueType.contains("DATE") ? ":" : MyDirectGraphVars.hyphenDelimeter);
            String items = "";
            String weights = "";
            String itemSeq = "";
            String weightSeq = "";
