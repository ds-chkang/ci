 ...
 */
public class MyDirectGraphNodeLabelFeatureGenerator {
    ...
    public MyDirectGraphNodeLabelFeatureGenerator() {}

    public void generateNodeLabelFeatures(String nodeLabelVariable, ArrayList<ArrayList<String>> dataIn, String nodeLabelType) {
        this.fw = new MyDirectGraphWeightFeatureWriter(nodeLabelVariable.replaceAll(" ", "").toLowerCase(Locale.ENGLISH)+ MyDirectGraphVars.nodeLabelFileExt);
        setObjectIDIndex();
