 ...
 */
public class MyDirectGraphEdgeLabelFeatureGenerator {
    ...
    public MyDirectGraphEdgeLabelFeatureGenerator() {}

    public void generateEdgeLabelFeatures(String edgeValueVariable, ArrayList<ArrayList<String>> dataIn, String edgeValueType) {
        this.fw = new MyDirectGraphWeightFeatureWriter(edgeValueVariable.replaceAll(" ", "").toLowerCase(Locale.ENGLISH) + MyDirectGraphVars.edgeLabelFileExt);
        setObjectIDIndex();
    ...
    private void setWeightNameIndex(String edgeWeightVariable) {weightLoc = MyDirectGraphVars.app.getDirectGraphMsgBroker().getHeaderIndex(edgeWeightVariable);}

    private void setItemNameIndex(String itemIDColNm) {itemLoc = MyDirectGraphVars.app.getDirectGraphMsgBroker().getHeaderIndex(itemIDColNm);}
    ...
    private void run(ArrayList<ArrayList<String>> dataIn, String edgeValueType) {
        try {
            String itemsetDelimeter = MyDirectGraphVars.hyphenDelimeter;
            String items = "";
            String weights = "";
            String itemSeq = "";
            String weightSeq = "";
