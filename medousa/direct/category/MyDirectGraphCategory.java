...
public class MyDirectGraphCategory {
    ...
    public MyDirectGraphCategory() {}
    public MyDirectGraphCategory(String name, double min, double max, int headerIndex, int numOfCategories) {
