...
public class MyDirectGraphVars {
    ...
    public static MyDirectGraph<MyDirectNode, MyDirectEdge> directGraph;
    ...
    public static double avgShortestOutDistance = 0.0D;
    ...
    public static MyDirectGraphVariableMap variableToIdMap = new MyDirectGraphVariableMap();
    public static Map<String, String> userDefinedEdgeValues = new HashMap<>();
    public static Set<String> userDefinedEdgeLabesl = new HashSet<>();
    public static Set<String> userDefinedNodeLabels = new HashSet<>();
    public static Map<String, String> userDefinedNodeValues = new HashMap<>();
    public static Map<Integer, Long> pathLengthByDepthMap = new HashMap<>();
    public static MyDirectGraphDashBoard directMarkovChainDashBoard;
    public static MyDirectGraphViewer getDirectGraphViewer() {return MyDirectGraphVars.app.getDirectGraphMsgBroker().getDirectMarkovChainContainer();}
