...
implements Serializable {
    ...
    public String getName() {return this.source.getCurrentLabel() + "-" + this.dest.getCurrentLabel();}
    ...
    public void setSupport() {this.support = (float)this.getContribution()/ MyDirectGraphVars.directGraph.getTotalEdgeContribution();}
    public void setLift() {
        this.lift = ((float)this.getContribution()/ MyDirectGraphVars.directGraph.getTotalEdgeContribution())/
            (((float)this.getSource().getContribution()/ MyDirectGraphVars.directGraph.getTotalEdgeContribution())*((float)this.getDest().getContribution()/ MyDirectGraphVars.directGraph.getTotalEdgeContribution()));
    }
