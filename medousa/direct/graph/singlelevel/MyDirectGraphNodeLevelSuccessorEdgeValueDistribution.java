...
public class MyDirectGraphNodeLevelSuccessorEdgeValueDistribution
extends JPanel {

    private boolean isValueExists = false;
    private boolean MAXIMIZED;

    public MyDirectGraphNodeLevelSuccessorEdgeValueDistribution() {
        this.decorate();
    }
            ...
            SwingUtilities.invokeLater(new Runnable() {
                @Override public void run() {
                    ...
                    if (!isValueExists) {
                        ...
                        barRenderer.setBaseLegendTextFont(MyDirectGraphVars.tahomaBoldFont12);
                        ...
                        enlargeBtn.setFont(MyDirectGraphVars.tahomaBoldFont12);
    ...
    public void enlarge() {
        ...
        try {
            MyDirectGraphNodeLevelSuccessorEdgeValueDistribution nodeLevelSuccessorEdgeValueDistribution = new MyDirectGraphNodeLevelSuccessorEdgeValueDistribution();
            nodeLevelSuccessorEdgeValueDistribution.MAXIMIZED = true;
            ...
            f.getContentPane().add(nodeLevelSuccessorEdgeValueDistribution, BorderLayout.CENTER);
