...
public class MyDirectGraphNodeLevelPredecessorValueDistribution
        extends JPanel {

    private boolean isValueExists = false;
    private boolean MAXIMIZED;

    public MyDirectGraphNodeLevelPredecessorValueDistribution() {
        this.decorate();
    }
    ...
    public void enlarge() {
        ...
        try {
            MyDirectGraphNodeLevelPredecessorValueDistribution nodeLevelPredecessorValueDistribution = new MyDirectGraphNodeLevelPredecessorValueDistribution();
            nodeLevelPredecessorValueDistribution.MAXIMIZED = true;
            ...
            f.getContentPane().add(nodeLevelPredecessorValueDistribution, BorderLayout.CENTER);
    ...
    private JFreeChart setChart() {
        ...
        Collection<MyDirectNode> nodes = MyDirectGraphVars.directGraph.getPredecessors(MyDirectGraphVars.getDirectGraphViewer().selectedSingleNode);
        if (nodes != null) {
