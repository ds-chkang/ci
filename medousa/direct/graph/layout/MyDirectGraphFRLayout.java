...
public class MyDirectGraphFRLayout<V, E> extends AbstractLayout<V, E> implements IterativeContext {
    ...
    public MyDirectGraphFRLayout(Graph<V, E> g, Dimension d) {
