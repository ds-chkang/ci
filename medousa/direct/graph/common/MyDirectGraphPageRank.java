 ...
 */
public class MyDirectGraphPageRank<V,E> extends PageRankWithPriors<V,E>
{
     ...
     */
    public MyDirectGraphPageRank(Hypergraph<V,E> graph, Transformer<E, ? extends Number> edge_weight, double alpha)
    {
     ...
     * @param alpha the probability of taking a random jump to an arbitrary vertex
     */
    public MyDirectGraphPageRank(Hypergraph<V,E> graph, double alpha)
    {
