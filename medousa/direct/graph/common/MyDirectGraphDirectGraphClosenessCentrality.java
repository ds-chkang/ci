 ...
 */
public class MyDirectGraphDirectGraphClosenessCentrality<V,E> extends MyDirectGraphDistanceCentralityScorer<V,E>
{
     ...
     */
    public MyDirectGraphDirectGraphClosenessCentrality(Hypergraph<V,E> graph, Distance<V> distance)
    {
     ...
     */
    public MyDirectGraphDirectGraphClosenessCentrality(Hypergraph<V,E> graph, Transformer<E, ? extends Number> edge_weights)
    {
     ...
     * @param graph
     */
    public MyDirectGraphDirectGraphClosenessCentrality(Hypergraph<V,E> graph)
    {
        super(graph, true);
    }
}
