...
public class MyDirectGraphMultiNodeLevelSharedPredecessorEdgeValueDistributionLineChart
extends JPanel {

    private boolean isValueExists;
    private static boolean MAXIMIZED;

    public MyDirectGraphMultiNodeLevelSharedPredecessorEdgeValueDistributionLineChart() {
        this.decorate();
    }
    ...
    private JFreeChart setChart() {
        try {
            ...
            for (MyDirectEdge e : edges) {
                if (MyDirectGraphVars.getDirectGraphViewer().multiNodeSharedPredecessorSet.contains(e.getSource())) {
            ...
            for (Integer value : valueMap.keySet()) {
                dataset.addValue(valueMap.get(value), "SHARED P. E. V.", value);
            }
    ...
    public void enlarge() {
        ...
        try {
            MyDirectGraphMultiNodeLevelSharedPredecessorEdgeValueDistributionLineChart multiNodeLevelSharedPredecessorEdgeValueDistributionLineChart = new MyDirectGraphMultiNodeLevelSharedPredecessorEdgeValueDistributionLineChart();
            multiNodeLevelSharedPredecessorEdgeValueDistributionLineChart.MAXIMIZED = true;
            ...
            f.getContentPane().add(multiNodeLevelSharedPredecessorEdgeValueDistributionLineChart, BorderLayout.CENTER);
            f.pack();
