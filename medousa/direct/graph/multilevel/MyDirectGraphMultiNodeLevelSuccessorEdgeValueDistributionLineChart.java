...
public class MyDirectGraphMultiNodeLevelSuccessorEdgeValueDistributionLineChart
extends JPanel {

    private boolean isValueExists;
    public MyDirectGraphMultiNodeLevelSuccessorEdgeValueDistributionLineChart() {
        this.decorate();
    }
    ...
    private JFreeChart setChart() {
        try {
            ...
            for (MyDirectNode n : MyDirectGraphVars.getDirectGraphViewer().multiNodes) {
                Set<MyDirectEdge> edges = new HashSet<>(MyDirectGraphVars.directGraph.getOutEdges(n));
    ...
    public void enlarge() {
        ...
        try {
            MyDirectGraphMultiNodeLevelSuccessorEdgeValueDistributionLineChart multiNodeLevelSuccessorEdgeValueDistributionLineChart = new MyDirectGraphMultiNodeLevelSuccessorEdgeValueDistributionLineChart();
            multiNodeLevelSuccessorEdgeValueDistributionLineChart.MAXIMIZED = true;
            ...
            f.getContentPane().add(multiNodeLevelSuccessorEdgeValueDistributionLineChart, BorderLayout.CENTER);
            f.pack();
