...
public class MyDirectGraphMultiNodeLevelPredecessorValueDistributionLineChart
extends JPanel {

    private static boolean MAXIMIZED;
    public MyDirectGraphMultiNodeLevelPredecessorValueDistributionLineChart() {
        this.decorate();
    }
        ...
        SwingUtilities.invokeLater(new Runnable() {
            @Override public void run() {
                    ...
                    try {
                        ...
                        enlargeBtn.setFont(MyDirectGraphVars.tahomaPlainFont10);
    ...
    private JFreeChart setChart() {
        try {
            ...
            if (MyDirectGraphVars.getDirectGraphViewer().multiNodePredecessorSet != null) {
                for (MyDirectNode n : MyDirectGraphVars.getDirectGraphViewer().multiNodePredecessorSet) {
    ...
    public void enlarge() {
        ...
        try {
            MyDirectGraphMultiNodeLevelPredecessorValueDistributionLineChart multiNodeLevelPredecessorValueDistributionLineChart = new MyDirectGraphMultiNodeLevelPredecessorValueDistributionLineChart();
            multiNodeLevelPredecessorValueDistributionLineChart.MAXIMIZED = true;
            ...
            f.getContentPane().add(multiNodeLevelPredecessorValueDistributionLineChart, BorderLayout.CENTER);
            f.pack();
