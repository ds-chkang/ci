...
public class MyEdgeValueTable
extends MyTable {

    private final String [] isWeights = {" YES", " NO"};
    private final String [] calculationTypes = {" VALUE TYPE", " SUM", " AVERAGE", " DIFFERENCE", " DISTINCT", " MAXIMUM"};
    private final Object [] columns = {" COLUMN", " EDGE VALUE", " VALUE TYPE"};
    private final Object [][] data = {};

    public MyEdgeValueTable() {
        super();
    ...
    public void update(String [] headers, boolean isUpdate) {
        ...
        for (int i = 0; i < headers.length; i++) {
            ...
            model.setValueAt(" VALUE TYPE", rowCnt++, 2);
        }
    }
