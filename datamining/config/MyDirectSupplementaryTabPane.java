 ...
 */
public class MyDirectSupplementaryTabPane
extends MyDirectTabPane {

    private final String TAB_TITLE = "SUPPLEMENTARY VARIABLES    ";
    private JPanel tablePanel;
    private JScrollPane tableScrollPane;
    private MyDirectSupplementaryTable supplemenVariableTable;


    public MyDirectSupplementaryTabPane() {
        super();
        this.decorate();
    }
    ...
    public void setTable() {
        this.supplemenVariableTable = new MyDirectSupplementaryTable() {
            @Override
    ...
    public MyDirectSupplementaryTable getTable() {
