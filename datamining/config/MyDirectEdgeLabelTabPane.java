...
public class MyDirectEdgeLabelTabPane
extends MyDirectTabPane {

    private final String TAB_TITLE = " EDGE LABELS  ";
    private MyDirectEdgeLabelTable edgeNameTable;
    ...
    public MyDirectEdgeLabelTabPane() {
        super();
        this.decorate();
    }
    ...
    public void setTable() {
        this.edgeNameTable = new MyDirectEdgeLabelTable() {@Override
    ...
    public MyDirectEdgeLabelTable getTable() {return this.edgeNameTable;}
}