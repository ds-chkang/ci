...
public class MyDirectEdgeValueTabPane
extends MyDirectTabPane {

    private final String TAB_TITLE = " EDGE VALUES  ";
    private MyDirectEdgeValueTable edgeValueTable;
    ...
    public MyDirectEdgeValueTabPane() {
        super();
        this.decorate();
    }
    ...
    public void setTable() {
        this.edgeValueTable = new MyDirectEdgeValueTable() {@Override
        ...
        this.tableScrollPane.setPreferredSize(new Dimension(650, 190));
    ...
    public MyDirectEdgeValueTable getTable() {return this.edgeValueTable;}
}