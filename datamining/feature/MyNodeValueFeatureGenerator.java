...
public class MyNodeValueFeatureGenerator {
    ...
    public void generateValueFeatures(String edgeValueVariable, ArrayList<ArrayList<String>> dataIn, String edgeValueType) {
        this.fw = new MyWeightFeatureWriter(edgeValueVariable.replaceAll(" ", "").toLowerCase(Locale.ENGLISH) + MyVars.nodeValueFileExt);
        setObjectIDIndex();
    ...
    private void setWeightNameIndex(String edgeWeightVariable) {
        weightLoc = MyVars.app.getMsgBroker().getHeaderIndex(edgeWeightVariable);
    }

    private void setItemNameIndex(String itemIDColNm) {
        itemLoc = MyVars.app.getMsgBroker().getHeaderIndex(itemIDColNm);
    }
    ...
    private void run(ArrayList<ArrayList<String>> dataIn, String edgeValueType) {
        try {
            String itemsetDelimeter = (edgeValueType.contains("TIME") || edgeValueType.contains("DATE") ? ":" : MyVars.hyphenDelimeter);
            String items = "";
            String weights = "";
            String itemSeq = "";
            String weightSeq = "";
