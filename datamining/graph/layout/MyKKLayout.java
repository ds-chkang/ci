 ...
 */
public class MyKKLayout<V,E> extends AbstractLayout<V,E> implements IterativeContext {

    private double EPSILON = 0.2d;

    private int currentIteration;
    private int maxIterations = 20000000;
    ...
    /**
     * Retrieves datamining.spm.edu.uci.ics.jung.graph distances between vertices of the visible datamining.spm.edu.uci.ics.jung.graph
     */
    protected Distance<V> distance;

    /**
     * The diameter of the visible datamining.spm.edu.uci.ics.jung.graph. In other words, the maximum over all pairs
     * of vertices of the length of the shortest path between a and bf the visible datamining.spm.edu.uci.ics.jung.graph.
     */
    ...
    /**
     * A multiplicative factor which specifies the fraction of the datamining.spm.edu.uci.ics.jung.graph's diameter to be
     * used as the inter-vertex distance between disconnected vertices.
     */
    private double disconnected_multiplier = 0.6;
    ...
    /**
     * Creates an instance for the specified datamining.spm.edu.uci.ics.jung.graph and distance metric.
     */
    public MyKKLayout(Graph<V,E> g, Distance<V> distance){
        super(g);
    ...
    /**
     * Sets a multiplicative factor that specifies the fraction of the datamining.spm.edu.uci.ics.jung.graph's diameter to be
     * used as the inter-vertex distance between disconnected vertices.
     */
