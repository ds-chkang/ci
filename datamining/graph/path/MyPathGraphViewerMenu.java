...
public class MyPathGraphViewerMenu
extends JPopupMenu
implements ActionListener {
    ...
    public MyPathGraphViewerMenu(MyPathGraphViewer betweenPathGraphViewer) {
    ...
    private void decorate() {
        ...
        this.nodeContributionStatistics.setFont(MyVars.tahomaPlainFont12);
        this.nodeContributionStatistics.addActionListener(this);
        this.edgeContributionStatistics.setFont(MyVars.tahomaPlainFont12);
        this.edgeContributionStatistics.addActionListener(this);
        this.showPathFlow.setFont(MyVars.tahomaPlainFont12);
