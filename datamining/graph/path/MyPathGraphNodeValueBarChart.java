...
public class MyPathGraphNodeValueBarChart extends JPanel {
    ...
    public MyPathGraphNodeValueBarChart(MyDepthFirstGraphPathSercher betweenPathGraphDepthFirstSearch) {
    ...
    public synchronized void setNodeValueBarChart() {
        ...
        Collection<MyDirectNode> nodes = ((MyDirectMarkovChain)this.betweenPathGraphDepthFirstSearch.betweenPathGraphViewer.getGraphLayout().getGraph()).getVertices();
