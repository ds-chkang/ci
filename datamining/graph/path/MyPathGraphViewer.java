...
public class MyPathGraphViewer
...
implements Serializable {
    ...
    protected MyPathGraphNodeValueBarChart betweenPathGraphNodeValueBarChart;
    protected MyPathGraphEdgeValueBarChart betweenPathGraphEdgeValueBarChart;
    private MyDirectMarkovChain pathGraph;
    protected MyDepthFirstGraphPathSercher betweenPathGraphDepthFirstSearch;
    protected LinkedHashMap<String, Long> nodeOrderMap;

    public MyPathGraphViewer(VisualizationModel<MyDirectNode, MyDirectEdge> vm) {
        super(vm);
        ...
        this.scale();
        this.pathGraph = (MyDirectMarkovChain) vm.getGraphLayout().getGraph();
        ...
        this.addMouseListener(new MyPathGraphViewerMouseListener(this));
        this.addMouseMotionListener(new MyPathGraphMouseMotionListener(this));
        this.addGraphMouseListener(new MyPathGraphMouseListener(this));
    }
    ...
    public void setNodeOrderMap() {
        ...
        LinkedHashMap orderedNodeMap = MySysUtil.sortMapByLongValue(this.nodeOrderMap);
        long i=0;
