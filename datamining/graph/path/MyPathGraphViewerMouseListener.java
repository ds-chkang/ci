...
public class MyPathGraphViewerMouseListener
implements MouseListener {

    private MyDirectNode mouseOverNode;
    private MyPathGraphViewer betweenPathGraphViewer;

    public MyPathGraphViewerMouseListener(MyPathGraphViewer betweenPathGraphViewer) {
                ...
                new Thread(new Runnable() {
                    @Override public void run() {
                        if (SwingUtilities.isRightMouseButton(e) &&
                            ...
                            MyPathGraphViewerMenu betweenPathGraphViewerMenu = new MyPathGraphViewerMenu(betweenPathGraphViewer);
