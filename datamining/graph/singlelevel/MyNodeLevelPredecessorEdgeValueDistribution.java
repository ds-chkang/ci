...
public class MyNodeLevelPredecessorEdgeValueDistribution
extends JPanel {
    ...
    public MyNodeLevelPredecessorEdgeValueDistribution() {
        this.decorate();
    }
            ...
            SwingUtilities.invokeLater(new Runnable() {
                @Override public void run() {
                    ...
                    if (!isValueExists) {
                        ...
                        titleLabel.setToolTipText("CURRENT PREDECESSOR EDGE VALUE DISTRIBUTION");
    ...
    public void enlarge() {
        ...
        frame.getContentPane().add(new MyNodeLevelPredecessorEdgeValueDistribution(), BorderLayout.CENTER);
