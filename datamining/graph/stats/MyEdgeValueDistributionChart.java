...
extends JFrame {
    ...
    private void decorateDistributionWithEdgeValues(String xAxisTitle) {
        try {
            ...
            chart.getCategoryPlot().getDomainAxis().setTickLabelFont(MyVars.f_pln_11);
            chart.getCategoryPlot().getDomainAxis().setLabelFont(MyVars.f_pln_11);
            chart.getCategoryPlot().getRangeAxis().setTickLabelFont(MyVars.f_pln_11);
