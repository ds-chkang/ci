...
public class MyDirectDelegateLayout<V, E>
...
implements IterativeContext {
    ...
    private int mMaxIterations = 50000;

    private Map<V, FRVertexData> frVertexData =
        LazyMap.decorate(new HashMap<V,FRVertexData>(),
    ...
    private double attraction_multiplier = 1.5;
    private double attraction_constant;
    private double repulsion_multiplier = 0.65; // from 0.55
     ...
     */
    public MyDirectDelegateLayout(Graph<V, E> g) {
        super(g);
    }
     ...
     */
    public MyDirectDelegateLayout(Graph<V, E> g, Dimension d) {
