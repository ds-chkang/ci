...
implements ActionListener, WindowListener {
    ...
    private JPanel getRightPanel() {
        ...
        this.addBtn.setFont(MyVars.tahomaPlainFont11);
    ...
    private JPanel getLeftPanel() {
        ...
        edgeValueLabel.setFont(MyVars.tahomaPlainFont12);
        ...
        this.edgeValueComboBoxMenu.setFont(MyVars.tahomaPlainFont12);
        ...
        nodeValueLabel.setFont(MyVars.tahomaPlainFont12);
        ...
        this.nodeValueComboBoxMenu.setFont(MyVars.tahomaPlainFont12);
        ...
        nodeOptionLabel.setFont(MyVars.tahomaPlainFont12);
        ...
        this.nodeOptionComboBoxMenu.setFont(MyVars.tahomaPlainFont11);
        ...
        this.nodeValueCheckBoxMenu.setFont(MyVars.tahomaPlainFont11);
        ...
        this.nodeNameCheckBoxMenu.setFont(MyVars.tahomaPlainFont11);
        ...
        this.edgeValueCheckBoxMenu.setFont(MyVars.tahomaPlainFont11);
        ...
        this.nodeWeightCheckBoxMenu.setFont(MyVars.tahomaPlainFont11);
        ...
        this.edgeWeightCheckBoxMenu.setFont(MyVars.tahomaPlainFont11);
        ...
        this.statisticLabel.setFont(MyVars.tahomaPlainFont11);
