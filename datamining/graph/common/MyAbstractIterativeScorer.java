 ...
 */
public abstract class MyAbstractIterativeScorer<V,E,T> implements IterativeContext, MyVertexScorer<V,T>
{
    /**
     ...
     */
    public MyAbstractIterativeScorer(Hypergraph<V,E> g, Transformer<E, ? extends Number> edge_weights)
    {
        this.graph = g;
     ...
     * @param g the graph for which the instance is to be created
     */
    public MyAbstractIterativeScorer(Hypergraph<V,E> g)
    {
    	this.graph = g;
        this.max_iterations = 100;
        this.tolerance = 0.001;
