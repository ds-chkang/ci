...
implements IterativeContext {
    ...
    private int mMaxIterations = 500000;
    ...
    private double repulsion_multiplier = 0.7; // from 0.55
    ...
    protected synchronized void calcPositions(V v) {
        ...
        //System.out.println(MySysUtil.getDecodedNodeName(((MyPlusNode) v).getName()) + "   " + newXPos + "     " + newYPos);
    ...
    protected void calcRepulsion(V v1) {
        ...
        } catch(ConcurrentModificationException cme) {calcRepulsion(v1);}
    }
